...
- **[Knowledge](knowledge/index.md)** — Direct-HTTP knowledge-store client with pydantic-ai tool integration.
- **[Refdocs](refdocs/index.md)** — Direct-HTTP documentation search and retrieval.
- **[Self-Review](self_review/index.md)** — Direct-HTTP agent activity review client.
