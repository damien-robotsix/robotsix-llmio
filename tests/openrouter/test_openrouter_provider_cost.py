"""OpenRouter provider-cost read seam & offline unit tests.

The OpenRouter activity fetch and per-key usage endpoints hit httpx, so they
are exercised with ``httpx.MockTransport`` (no network, no respx dependency).
"""
